...
public class insert {
    ...
    public static void showWindow() {
        ...
        frmAddStudent.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\Ahmed Awd Allah\\eclipse-workspace\\Student_Record\\logo.png"));
        frmAddStudent.setBackground(Color.DARK_GRAY);
        frmAddStudent.setAlwaysOnTop(true);
